...
class Admin extends React.Component {
  ...
  getTableList = () => {
    if (
      this.params["structuredStartTime"] &&
      this.params["structuredEndTime"] &&
      this.params["structuredStartTime"] > this.params["structuredEndTime"]
    ) {
    ...
    adminStructuredList(this.params)
      .then((res) => {
        //判断状态码 判断结果是否存在
