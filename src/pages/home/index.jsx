...
import DebtDetail from "../debt-structure/detail";
  ...
  get Routers() {
    ...
    const BankruptRoutes = [
      <Route
        path="/index/bankrupt"
        exact
        component={BankruptList}
        remark="破产结构化 - 列表"
        key="bankrupt"
      />,
      <Route
        path="/index/bankrupt/detail/:id"
        component={BankruptDetail}
        remark="破产结构化 - 详情页"
        key="bankrupt-detail"
      />,
    ];
      ...
      <Layout style={{ height: "100%" }}>
        ...
        <Layout>
          ...
          <Content id="yc-layout-main">
            <div className="yc-right-content">{this.Routers}</div>
          </Content>
        </Layout>
      </Layout>
    );
