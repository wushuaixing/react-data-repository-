  ...
  async handleSubmit(params) {
    ...
    if (res.data.code === 200) {
      ...
      this.props.history.push({
        pathname: "/index",
        query: { info: "success", rule: res.data.data.FUNCTIONS },
      });
    } else {
      this.setState(
        {
    ...
    return (
      <Spin tip="Loading..." spinning={loading}>
        <div className="yc-login">
          <div className="yc-login-header" data-remark="头部图标和公司文字">
            <img src={logo} alt="" />
          </div>
            ...
            <div className="yc-container-body">
              ...
              {showForm === "login" && (
                <div
                  className={
                    errorCount < 3
                      ? "yc-right-login-noCode"
                      : "yc-right-login-withCode"
                  }
                >
                  ...
                  <Form className="login-form">
                    ...
                    <Form.Item style={{ marginTop: -20 }}>
                      ...
                      <Button
                        ...
                        onMouseDown={this.handleCorrect}
                      >
                        登录
                      </Button>
                    </Form.Item>
                  ...
                  {isLocal && (
                    <div className="temp-module">
                      <Button
                        onClick={() =>
                          set({ username: "18358141463", password: "123456" })
                        }
                      >
                        管理员
                      </Button>
                      <Button
                        onClick={() =>
                          set({ username: "55555555555", password: "555555" })
                        }
                      >
                        检查人员
                      </Button>
              ...
              {showForm === "findPassword" && (
                <ForgetPasswordForm
                  handleSwitchBack={this.switchForm.bind(this)}
                  resetPasswordSuccess={this.handleResetPasswordSuccess.bind(
                    this
                  )}
                />
              )}
