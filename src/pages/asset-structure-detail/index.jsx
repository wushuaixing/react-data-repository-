            ...
            getAuctionDetail(params.id).then(result => {
                ...
                if (res.code === 200) {
                    ...
                    this.setState({
                        ...
                        obligors: data && data.obligors && data.obligors.length === 0 && params.status === '0' && this.getRole() === 'structure' ? [getObligors()] : data.obligors,//结构化人员待标记列下默认显示一条
                            ...
                            <div className="assetstructure-detail_header">
                                资产结构化{this.getRole()==='check' ? '检查':null}/详情
                                {
                                    ...
                                    <Button type="primary" ghost className='buttonGroup-back'
                                            onClick={this.handleBack.bind(this, true)} style={{width: 90}}>返回</Button>
                                }
                            </div>
                    }
