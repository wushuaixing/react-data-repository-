...
class Check extends React.Component {
  ...
  addRemark(text, flag) {
    const val = this.props.form.getFieldValue("remark")
      ? this.props.form.getFieldValue("remark")
      : "";
  ...
  render() {
    ...
    wrongReasons =
      wrongReasons && wrongReasons instanceof Array && wrongReasons.length > 0
        ? wrongReasons[wrongReasons.length - 1]
        : {};
        ...
        >
          <div className="check-modal">
            ...
            <Form style={{ width: 354 }}>
              ...
              <Form.Item
                className="wrongLevel"
                label="错误等级"
                style={{ fontSize: 12 }}
              >
                {getFieldDecorator("wrongLevel", {
                  initialValue:
                    wrongReasons.wrongLevel && isShowWrongRemark
                      ? wrongReasons.wrongLevel
                      : 0,
                })(
              ...
              <Form.Item className="wrongTypes" label="出错位置">
                {getFieldDecorator("wrongTypes", {
                  initialValue:
                    wrongReasons.auctionExtractWrongTypes && isShowWrongRemark
                      ? wrongReasons.auctionExtractWrongTypes
                      : [],
                })(
