                    ...
                    <ul>
                        <Item title='抵押情况：'>
                            <div>
                            {
                                ...
                                <Checkbox name="collateral" onChange={this.handleChange} disabled={enable} checked={collateral}>无抵押</Checkbox>
                            }
                            </div>
                        </Item>
                        <Item title='房产/土地类型：'>
                            ...
                            {  
                                ...
                                <Radio.Group value={houseType} onChange={this.handleChange} name="houseType" disabled={enable}>
                                    {
                        ...
                        <Item title='建筑面积：'>
                            <div>
                                {
                                    enable ?
                                    <span>{filters.filterNullKey(buildingArea)&&parseInt(buildingArea)!==-1?<span>{buildingArea.toFixed(2)} m<sup>2</sup></span>:'-'}</span> :
                                    <span>
                                        <InputNumber
                                            precision={2} style={{ width: 200 }} max={999999999.99}
                                            min={0}
                                            placeholder="请输入建筑面积" name="buildingArea"
                                            onChange={this.handleChange} value={buildingArea} />&nbsp;&nbsp;m<sup>2</sup>
                                    </span>
                                }
                            </div>
                        </Item>
