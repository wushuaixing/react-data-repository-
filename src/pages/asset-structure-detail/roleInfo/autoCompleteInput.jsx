...
class autoCompleteInput extends Component {
    ...
    handChange(...rest) {
        ...
        const params = flags ? (rest[2] || '').trim().replace(/[(]/g, '（').replace(/[)]/g, '）') : (rest[2] || '');
    ...
    render() {
        ...
        return (
            <div className="auto_complete_content">
                ...
                {
                    paramsLengthList[index] && isBlur === 'onBlur' ?
                        <p className="auto_complete_nodata">未匹配到对应的工商信息</p> : null
                }
                {
                    paramsLengthList[index] && isBlur === 'onChange' ?
                        <div className="auto_complete_nodatas">未匹配到对应的工商信息</div> : null
                }
            </div>
        )
    }
