...
function HotDotBeforeFormItem(props = { top: 0, left: 0 }) {
  return (
    <span
      ...
      className="yc-components-hotDot"
    >
      *
    </span>
  );
    ...
    <div className="yc-components-breadCrumb">
      ...
      {props.breadButtonText ? (
        <div className="yc-components-breadCrumb_button">
          {props.note ? (
            <span className="yc-components-breadCrumb_button-note">
              {props.note}
            </span>
          ) : null}
          <Button
  ...
  return (
    <div className="yc-components-searchAndClearButtonGroup">
      <Button
        type="primary"
        htmlType="submit"
        className="yc-components-searchAndClearButtonGroup_search"
      ...
      <Button
        ...
        className="yc-components-searchAndClearButtonGroup_clear"
        loading={props.loading}
      >
        清空搜索条件
      </Button>
...
function AssetTabTextWithNumber(props = { num: null, text: "" }) {
  if (props.num != null) {
    return (
      <span>
        {props.text}
        <span className="yc-components-assetTabTextWithNumber">
          ({props.num})
        </span>
      </span>
    );
